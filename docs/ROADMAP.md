...
- [ ] **Deferred — UX Refinement V1 Android visual/function matrix** — owner toggle, stop/booking CRUD, and delete confirmation still need an emulator pass. A 2026-09-03 Pixel 8 pass opened Companion/Plan/Map/Bookings/More on Nagawa, created traveler Alex on isolated Lisbon, opened traveler create/edit and Trip Details forms, then cold-relaunched to Home with live `user_version` 17.
...
- Phase 5 visual/function matrix remainder: owner toggle, stop/booking CRUD, and delete confirmation. Travelers create/edit and Trip Details forms were opened on Pixel 8 on 2026-09-03.
