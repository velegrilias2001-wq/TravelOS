...
- Elevation Program Wave 2 is implemented on this branch: Create Trip progressive disclosure (Where → When → Shape/Create) with step pips, RiseIn, Continue CTAs, and a finish review card. Android emulator smoke on 2026-09-05 showed Step 1 Where with disabled Continue until a destination is chosen. Waves 3–4 remain sequenced in `docs/ROADMAP.md`.
