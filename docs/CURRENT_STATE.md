...
Current limitations include no wishlist layer on World, no country statistics independent of saved destinations, and no use of Memories as World evidence. Saved Discover ideas live on their own list and are not World markers. A deeper travel-archive view from memories and place relationships remains later work.
...
- World lived-history semantics beyond explicit done-stop + Day → Destination labels. World planned vs lived V1 does not use trip status, destination titles, skipped stops, or wishlist rows as visits. Memories are still not World evidence.
